        ...
        "56d7": function(e, t, n) {
            ...
            var fe = n("8c4f"),
                ...
                ge = function() {
                    ...
                    }, [e._v(e._s(e.userInfo.userTypeName + ": " + e.userInfo.name))]), n("el-dropdown", {
            ...
            var Xe, Qe, Ze = {
                ...
                Wt = {
                    watch: {
                        $route: function(e) {
                            "mobile" === this.device && this.sidebar.opened && gn.dispatch("app/closeSideBar", {
                                withoutAnimation: !1
                            })
                        }
                    },
                    ...
                    mounted: function() {
                        ...
                        e && (gn.dispatch("app/toggleDevice", "mobile"), gn.dispatch("app/closeSideBar", {
                            withoutAnimation: !0
                        }))
                    },
                    methods: {
                        ...
                        $_resizeHandler: function() {
                            if (!document.hidden) {
                                var e = this.$_isMobile();
                                gn.dispatch("app/toggleDevice", e ? "mobile" : "desktop"), e && gn.dispatch("app/closeSideBar", {
                                    withoutAnimation: !0
                                })
                            }
                        }
