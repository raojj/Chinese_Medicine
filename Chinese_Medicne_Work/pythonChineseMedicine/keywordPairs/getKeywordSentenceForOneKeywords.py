...
if __name__ == "__main__":
    ...
    for keyword in keywords:
        ...
        xlsSt.AutoFilter(Field=1, Criteria1='*Keyword' + keywordCuts[1] + '*', Operator=1)
        # Criteria2='*'+keywordCuts[2]+'*')
        xlsSt.Select()
        ...
        doc.Content.ParagraphFormat.LineSpacingRule = 1.5
        ...
        doc.Content.Find.Execute(FindText='found_on_page', ReplaceWith='^p页码：', Replace=2)
        ...
        app.WordApp.Selection.WholeStory()
        cnt = 1
        while app.WordApp.Selection.Find.Execute('ENTER', False, False, True, False, False, True, 1, False,
                                                 '^p（' + str(cnt) + '）', 1, ):
            app.WordApp.Selection.Font.Bold = False
            cnt = cnt + 1

        doc.Content.Find.Execute(FindText='Keyword', ReplaceWith='^p关键词：', Replace=2)
        ...
        # doc.Content.Find.Execute(FindText='ABC*ABC', MatchWildcards=True, ReplaceWith=keywordCuts[1], Replace=2)
