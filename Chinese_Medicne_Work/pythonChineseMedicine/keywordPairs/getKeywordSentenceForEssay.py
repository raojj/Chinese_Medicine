...
if __name__=="__main__":
    ...
    resFileName = '文献.xlsx'    #input("请输入源文件名：")
    ...
    for keyword in keywords:    
        ...
        xlsSt.AutoFilter(Field=1, Criteria1='*Keyword'+keywordCuts[3]+'*', Operator=1,
...
#                app.WordApp.Selection.Font.Bold = True
        ...
        doc.Content.Find.Execute(FindText='ENTER', ReplaceWith='ENTERABC文章：', Replace=2)
        doc.Content.Find.Execute(FindText='keyword', ReplaceWith='ABC^p关键词：kw', Replace=2)
        doc.Content.Find.Execute(FindText='in_sentence', ReplaceWith='kw^p句子：', Replace=2)

        # 设置书名样式
        doc.Content.Find.ClearFormatting()
        doc.Content.Find.Replacement.ClearFormatting()    
        app.WordApp.Selection.WholeStory()
        while app.WordApp.Selection.Find.Execute('ABC*ABC', False, False, True,):
            app.WordApp.Selection.Font.Bold = True
            app.WordApp.Selection.Font.Name = "微软雅黑"
            app.WordApp.Selection.Font.Color = 16711680
            
        doc.Content.Find.Execute(FindText='ABC', ReplaceWith='', Replace=2)
        ...
        doc.Content.Find.Execute(FindText='kw*kw', MatchWildcards=True, ReplaceWith=keywordCuts[2]+'-'+keywordCuts[3], Replace=2)
