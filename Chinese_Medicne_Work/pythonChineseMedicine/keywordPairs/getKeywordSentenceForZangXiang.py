...
#                app.WordApp.Selection.Font.Bold = True
        ...
        doc.Content.Find.Execute(FindText='ABC*ABC', MatchWildcards=True, ReplaceWith=keywordCuts[1]+'-'+keywordCuts[2], Replace=2)
